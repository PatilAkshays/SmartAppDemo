...
class TopRatedVC: BaseViewController {
    ...
    @IBOutlet var topRatedViewModel: TopRatedViewModel!
   ...
   private func fetchTopRatedMovieList(){
        ...
        if Connectivity.isConnectedToInternet(){
            self.showLoading()
            self.topRatedViewModel?.requestNowPlayingMovieList(completion: { (response) in
                self.hideLoading()
                self.refreshControl.endRefreshing()
                
                if self.topRatedViewModel!.isTopRatedMovieSuccess(){
                    self.movieList = []
                    ...
                    print("Error + ",self.topRatedViewModel!.getTopRatedMovieSuccessMsg())
                    self.showAlertWithAction(msg: self.topRatedViewModel!.getTopRatedMovieSuccessMsg())
